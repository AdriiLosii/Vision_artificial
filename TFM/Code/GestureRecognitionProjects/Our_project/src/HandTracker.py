...
def draw_square(frame, centroid, square_size=350):
    """
    ...
    # Dibujar el cuadrado
    cv2.rectangle(frame, square_top_left, square_bottom_right, (0, 255, 0), 2)

def crop_frame(frame, centroid, square_size=350):
    """
